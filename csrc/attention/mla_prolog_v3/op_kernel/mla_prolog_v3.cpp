 ...
 * \brief Kernel entry. Template instantiations are limited by
 *        mla_prolog_template_tiling_key.h ASCENDC_TPL_SEL (compile-time trim).
 *        Kept branches match vllm-ascend usage:
 *          1) BF16 non-quant (QUANT_MODE=0)
 *          2) MXFP8 full quant (QUANT_MODE=7/8)
 */
